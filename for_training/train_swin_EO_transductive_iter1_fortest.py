...
def train():
    ...
    while iteration_num < 1:
        ...
        # for epoch in range(1):  # loop over the dataset multiple times
            ...
            if acc > best_acc:
                best_acc = acc
                torch.save(F1, 'swinB_F_bestacc_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num))
                torch.save(C1, 'swinB_C_bestacc_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num))

            torch.save(F1, 'swinB_F_now_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num))
            torch.save(C1, 'swinB_C_now_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num))

        print('Finished Training')
        torch.save(F1, 'swinB_F_final_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num))
        torch.save(C1, 'swinB_C_final_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num))
