...
def train():
    ...
    # F = torch.load('swinB_F_bestacc_Track2_EO12_iteration_num1_fortest.pth')
    F = torch.load('swinB_F_bestacc_Track2_EO_iteration_num1_fortest.pth')
    ...
    # C = torch.load('swinB_C_bestacc_Track2_EO12_iteration_num1_fortest.pth')
    C = torch.load('swinB_C_bestacc_Track2_EO_iteration_num1_fortest.pth')
    ...
    while iteration_num < 1:
        ...
        if iteration_num == 1:
            ...
            # F1 = torch.load('swinB_F_bestacc_Track2_EO12_iteration_num1_fortest.pth')
            F1 = torch.load('swinB_F_bestacc_Track2_EO_iteration_num1_fortest.pth')
        else:
        ...
        if iteration_num ==1:
            ...
            # C1 = torch.load('swinB_C_bestacc_Track2_EO12_iteration_num1_fortest.pth')
            C1 = torch.load('swinB_C_bestacc_Track2_EO_iteration_num1_fortest.pth')
        else:
        ...
        # for epoch in range(1):  # loop over the dataset multiple times
            ...
            if acc > best_acc:
                best_acc = acc
                torch.save(F1, 'swinB_F_bestacc_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num+1))
                torch.save(C1, 'swinB_C_bestacc_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num+1))

            torch.save(F1, 'swinB_F_now_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num+1))
            torch.save(C1, 'swinB_C_now_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num+1))

        print('Finished Training')
        torch.save(F1, 'swinB_F_final_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num+1))
        torch.save(C1, 'swinB_C_final_Track2_EO_iteration_num{}_fortest.pth'.format(iteration_num+1))

        sys.exit(0)
        ###################################################################################################
        ############## Please note that the following codes does not work #################################
        ###################################################################################################
